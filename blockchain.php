								...
								<div class="flex-column-fluid">
									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-blockchain-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table id="kt_datatable_blockchain" class="table align-middle table-row-dashed fs-6 gy-5">
    <thead>
...
<!--end::Datatable-->
		...
		<script src="assets/js/blockchainDatatable.js"></script>
